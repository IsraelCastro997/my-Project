    ...
    <body>
        ...
        <div class="unit-5 overlay" style="background-image: url('images/hero_bg_2.jpg');">
            <div class="container text-center">
                <h2 class="mb-0">Publica tu proyecto</h2>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 mb-5">
                        <div class="p-4 mb-3 bg-danger text-white">
                            ...
                            <form action="../controllers/project.php?o=1" method="POST" class="p-5 bg-white">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        ...
                                        <input type="text" id="namePostProject" name="namePostProject" class="form-control" placeholder="my-project" required="true">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-12 mb-3 mb-md-0">
                                        <label class="font-weight-bold" for="description">Descripción de proyecto</label>
                                        <textarea class="form-control" name="description" id="description" required="true" cols="30" rows="5"></textarea>
                                    </div>
                                    <script>
